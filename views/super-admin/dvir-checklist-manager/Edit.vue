            ...
            <div class="profile-info">
               <div class="inner-content pad0">
                  <div class="role-inner-container">
                     <div class="head1">{{ $t("dvir.edit_checklist") }}</div>
                              ...
                              <div class="col-md-4 col-sm-6 text-left">
                                 ...
                                 <div class="custom-input">
                                    <input
                                       ...
                                       v-validate="'required'"
                                       ref="checklistName"
                                       :class="{ 'is-invalid': errors.has('checklistName') }"
                                       autocomplete="off"
                                       />
                                 </div>
                              </div>
                              ...
                              <div class="row custom-gutter mb-3">
                                 <div class="col-md-4 col-sm-6 text-left responsive-mt-4">
                                    ...
                                    <div
                                       ...
                                       <p @click="addCategory()" class="ml-2 pr-5" style="cursor: pointer">
                                       ...
                                       <!-- <span @click="addCategory()" class="ml-2" style="cursor: pointer">
                                          <i class="innov-icon icon-add-plus fnt-15 pr-1 pl-1"></i>
                                          </span>
                                          <span
                                            v-if="index > 0"
                                            class="ml-2"
                                            style="position: absolute; right: 0px; bottom: 13px;"
                                            @click="removeCategory(index)"
                                          >
                                           <img src="@/assets/images/delete-cross.svg" alt="Delete Contact">
                                          </span> -->
                                    </div>
                                 </div>
                              </div>
                              <div
                                 ...
                                 <div class="col-md-12">
                                    <div class="row custom-width">
                                             ...
                                             <div class="row align-items-center">
                                                ...
                                                <div class="col-md-11">
                                                   <div class="row custom-gutter">
                                                      <div class="col-md-4 col-sm-4 text-left responsive-mt-4">
                                                      ...
                                                      <div class="col-12">
                                                         <div class="row">
                                                            <div class="col-md-3 col-sm-3 text-left responsive-mt-4">
                                                            ...
                                                            <div class="col-md-3 col-sm-3 text-left responsive-mt-4">
                                                               ...
                                                               <div class="custom-input">
                                                                  <multiselect
                                                                     ...
                                                                     :hideSelected="true"
                                                                     v-validate="'required'"
                                                                     v-bind:name="'largeIcon'"
                                                                     v-bind:ref="'largeIcon'"
                                                                     class="drop-multiselect-auth-img"
                                                                     :class="{ 'is-invalid': errors.has('largeIcon') }"
                                                                     >
                                                                     <template slot="singleLabel" slot-scope="props">
                                                                        <img
                                                                           class="option__image"
                                       ...
                                       <div class="col-md-1">
                                          <div class="drag-row-action">
                                             <span @click="addItem(index)" class="ml-2" style="cursor: pointer">
                                             <img src="@/assets/images/round-add.svg" alt="" />
                                             </span>
                                             <span
                                                v-if="ind > 0"
    ...
    async saveDvirChecklist() {
      ...
      if (result) {
        try {
          ...
          let resp = await this.createDvirChecklist({
            body: data,
