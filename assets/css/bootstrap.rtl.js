...
!(function(t, e) {
  ...
  e(document)
    ...
    e(window).on("load.bs.button.data-api", function() {
      ...
      for (
        var s = 0,
          r = (t = [].slice.call(document.querySelectorAll('[data-toggle="button"]'))).length;
        s < r;
        s++
      ) {
        var a = t[s];
          ...
          if (!this._isShown && !this._isTransitioning) {
            ...
            e(this._element).trigger(i),
              this._isShown ||
                ...
                e(this._element).on("click.dismiss.bs.modal", '[data-dismiss="modal"]', function(
                  t
                ) {
                  return n.hide(t);
                }),
      ...
      return (
        ...
        (i.setElementContent = function(t, n) {
          "object" != typeof n || (!n.nodeType && !n.jquery)
            ? this.config.html
              ? (this.config.sanitize && (n = Q(n, this.config.whiteList, this.config.sanitizeFn)),
                t.html(n))
              : t.text(n)
            : this.config.html
            ? e(n)
        ...
        (i._getConfig = function(t) {
          ...
          return (
            ...
            "number" ==
              typeof (t = s({}, this.constructor.Default, n, "object" == typeof t && t ? t : {}))
  ...
  var nt = "scrollspy",
    ...
    rt = (function() {
      ...
      return (
        ...
        (n._getConfig = function(t) {
          if (
            "string" != typeof (t = s({}, ot, "object" == typeof t && t ? t : {})).target &&
